...
// ─── App principal ────────────────────────────────────────────────────────────
export default function ModuloCaptura() {
    ...
    try {
      for (const evidencia of evidencias) {
        ...
        const { error: dbError } = await supabase
          ...
          .insert({
            sesion_id: sesionId,
            ubicacion: evidencia.metadata.ubicacion,
            categoria: evidencia.metadata.categoria,
            descripcion: evidencia.metadata.descripcion,
